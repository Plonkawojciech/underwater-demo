...
- Deploy: Coolify (projekt `underwater-demo`, Dockerfile), domena `underwater-demo.programo.pl`, wolumen `/data` (baza + media). Zmienne: `PAYLOAD_SECRET`, `DATABASE_URI=file:/data/payload.db`, `MEDIA_DIR=/data/media`, `NEXT_PUBLIC_SERVER_URL`.
